	  ...
	  <td>
	    ...
	    <table style="background-color: YellowGreen">
		  ...
		  <tr height="40">
			...
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
				<input type="password" style="width: 240" name="pwd" value="${customer.pwd}">
			</td>
		  </tr>
		  <tr height="40">
			<td width="150" align="center" bgcolor="E6ECDE">비밀번호 확인</td>
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
				<input type="password" style="width: 240" name="pwd2" value="${customer.pwd}">
			</td>
		  </tr>
		  <tr height="40">
			<td width="150" align="center" bgcolor="E6ECDE">이름</td>
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
				<input type="text" style="width: 240" name="name" value="${customer.name}">
			</td>
		  </tr>
		  <tr height="40">
		  ...
		  <tr height="40">
			<td width="150" align="center" bgcolor="E6ECDE">이메일</td>
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
